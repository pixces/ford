...
<div class="participateBlock">
    <div class="description">
        <div class="row-fluid">
            <div class="column_container transition">
                <span class="chooseCeleb"></span>
                Choose a celeb
            </div>
            <div class="column_container transition">
                <span class="teachSkill"></span>
                Teach them a new skill
            </div>
            <div class="column_container transition">
                <span class="win"></span>
                Win a Fiesta/EcoSport
            </div>
        </div>
        ...
        <div class="boxLink"><a href="javascript:void(0)">Participate now</a></div>
...
<div class="hotspots transition">
    <div class="hotspot col-first">
        <div class="img"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/rocky-mayur.png" alt="Rocky & Mayur" title="Rocky & Mayur" /></div>
        <div class="icon"></div>
    ...
    <div class="hotspot col-second">
        <div class="img"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/gaurav-kapoor.png" alt="Rocky & Mayur" title="Rocky & Mayur" /></div>
        <div class="icon"></div>
    ...
    <div class="hotspot col-three">
        <div class="img"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/anushka-dandekar.png" alt="Anushka Dandekar" title="Anushka Dandekar" /></div>
        <div class="icon"></div>
