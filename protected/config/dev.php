...
return CMap::mergeArray(
    ...
    array(
        ...
        'params'=>array(
            ...
            'API_URL'           => 'http://localhost/fordAdmin/api/v1/',
            'SOCIAL_URL'        => 'http://localhost/fordHTML/social/',
            'APP_CALLBACK'      => "http://localhost/fordHTML/social/authenticate",
            'CAPTCHA_URL'       => 'http://localhost/fordHTML/user/checkCaptcha',
