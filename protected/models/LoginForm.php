...
class LoginForm extends CFormModel
{
        ...
        const ERROR_ROLE_INVALID = "Not authorized to login";
	...
	public function authenticate($attribute,$params)
	{
		if(!$this->hasErrors())
		{
                    ...
                    if(!$this->_identity->authenticate($this->type)) {
	...
	{   	if($this->_identity===null)
		{
			$this->_identity=new UserIdentity($this->username,$this->password);
			$this->_identity->authenticate($this->type);
		}
                ...
                if($this->_identity->errorCode===UserIdentity::ERROR_NONE)
		{
			$duration=$this->rememberMe ? 3600*24*60 : 0; // 60 days
                        ...
                        User::model()->updateByPk($this->_identity->getId(),array('last_login_time' => new CDbExpression('NOW()')));
			return true;
		}
		else
			return false;
